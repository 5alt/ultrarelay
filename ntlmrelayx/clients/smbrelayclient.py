...
class MYSMB3(SMB3):
	...
	print "negResp['SecurityMode']",negResp['SecurityMode']
        print "SMB2_NEGOTIATE_SIGNING_REQUIRED",SMB2_NEGOTIATE_SIGNING_REQUIRED
...
class SMBRelayClient(ProtocolClient):
	...
	#negotiateMessage = negotiateMessage[:12]+'\x07\x02\x08\xa2'+negotiateMessage[16:]
	#negotiateMessage = negotiateMessage[:12]+'\x97\xb2\x08\xe2'+negotiateMessage[16:]
